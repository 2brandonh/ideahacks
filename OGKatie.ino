...
//  });
  ...
  server.on("/class", HTTP_GET, [](AsyncWebServerRequest *request){
  ...
  server.on("/eat", HTTP_GET, [](AsyncWebServerRequest *request){
  ...
  server.on("/study", HTTP_GET, [](AsyncWebServerRequest *request){
    digitalWrite(ledPin, HIGH); 
     delay(2000);
  display.clearDisplay();
  display.setCursor(0,0);
  ...
  server.on("/social", HTTP_GET, [](AsyncWebServerRequest *request){
    digitalWrite(ledPin, LOW); 
      delay(2000);
  display.clearDisplay();
  display.setCursor(0,0);
